...
# Optional data
EMAILS = ["1127700793@qq.com"]  # Receive error notifications by email
YOUR_EMAIL = "1127700793@qq.com"  # Account to send email from
EMAIL_PASSWORD = "970921wf,"  # Password for the email account
